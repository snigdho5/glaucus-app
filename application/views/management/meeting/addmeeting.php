...
<div class="wrapper" ng-controller="addMeetingCtrl">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <form name="addForm" novalidate>
            ...
            <button type="submit" class="btn btn-default pull-left" ng-click="cancelAddMeeting()">Cancel</button>
              <button type="submit" class="btn btn-primary pull-right" ng-disabled="addForm.$invalid" ng-click="submitAddMeeting()">Submit</button>
            </div>
          </form>
        </div>
        <!-- /.box -->
