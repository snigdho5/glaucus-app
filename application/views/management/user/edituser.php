<div class="wrapper" ng-controller="editUserCtrl">
          ...
          <form name="addForm" novalidate>
            ...
            <div class="row col-md-12">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="row col-md-12">
                    <div class="form-group col-md-6">
                        <div class="col-md-3" ng-if="userKyc">
                           <a href="<?= base_url('uploads/kyc/salesperson/') ?>{{userKyc}}" target="_blank">Download KYC</a>
                        </div>
                        <div class="col-md-9">
                            <label for="userKyc">Upload KYC Document (File format PDF) *</label>
                            <input type="file" ngf-select ng-model="picFile" name="file"                                 accept=".doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/pdf," ngf-max-size="2MB" ngf-model-invalid="errorFile"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-default pull-left" ng-click="cancelEditUser()">Cancel</button>
                  <button type="submit" class="btn btn-primary pull-right" ng-disabled="addForm.$invalid" ng-click="updateUser(picFile)">Update</button>
            </div>
          </form>
        </div>
        <!-- /.box -->
