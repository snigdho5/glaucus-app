...
<div class="wrapper" ng-controller="addCustomerCtrl">
          ...
          <form name="addForm" novalidate>
            ...
            <div class="row col-md-12" style="margin-bottom: 10px;">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" id="cusDOB" class="form-control floating-label" placeholder="Date of Birth">
              </div>

              <div class="form-group col-md-4">
                <label for="cusDOA">Date of Anniversary</label>
                <input type="text" id="cusDOA" class="form-control floating-label" placeholder="Date of Anniversary">
              </div>
            ...
            <button type="submit" class="btn btn-default pull-left" ng-click="cancelAddCustomer()">Cancel</button>
              <button type="submit" class="btn btn-primary pull-right" ng-disabled="addForm.$invalid" ng-click="submitAddCustomer()">Submit</button>
            </div>
          </form>
        </div>
        <!-- /.box -->
