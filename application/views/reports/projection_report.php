...
<div class="wrapper" ng-controller="rochakprojectionreport">
    ...
    <div class="container">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Projection Report</li>
        </ol>
      </section>
          ...
          <div class="col-md-12">
            ...
            <div class="box box-primary">
              <div class="box-header">
                <h3 class="box-title">Projection Report 
                  <small>Filter</small>
                </h3>
                <!-- tools box -->
            ...
            <div class="box box-primary" style="padding-left:10px; padding-right:10px;">
              ...
              <div class="box-body table-responsive no-padding" id="printBody">
                <div class="col-md-6"><h4><strong>Sales App Projection Report</strong></h4></div><div class="col-md-6" align="right"><h4><strong>{{reportDateInfo}}</strong></h4></div>
                <table class="table table-hover" id="tableToExport">
                  <thead>
                    <tr>
                      ...
                      <th ng-click="sort('projectionAmount')">Projection Amount
                  ...
                  <tbody>
                    <tr dir-paginate="projection in projections|orderBy:sortKey:reverse|filter:search|itemsPerPage:10000000">
                      <td>{{$index + 1}}</td>
                      <td>{{projection.projectionDate}}</td>
                      <td>{{projection.firstName}} {{projection.lastName}}</td>
                      <td>{{projection.collectionDate}}</td>
                      <td>{{projection.distributor}}</td>
                    ...
                    <tr>
                      ...
                      <td><h4><strong>&#8377; {{projectionTotalAmount}}</strong></h4></td>
                    </tr>
                  </tbody>
                  </table>
