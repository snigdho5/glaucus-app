...
<div class="wrapper" ng-controller="routehistoryCtrl">
    ...
    <div class="container">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Route History</li>
        </ol>
      </section>
            ...
            <div class="box box-primary" style="padding-left:10px; padding-right:10px;">
              <div class="box-header with-border">
                ...
                <div class="form-group col-md-2" style="margin-top:24px;">
                  <button type="button" ng-click="submitRoute()" class="btn btn-block btn-primary form-control" title="Refresh Table"><i class="fa fa-refresh"> </i> Submit</button>
                </div>
