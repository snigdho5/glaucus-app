...
<div class="wrapper" ng-controller="rochakordersreport">
          ...
          <div class="col-md-12">
            ...
            <div class="box box-primary">
              <div class="box-header">
                <h3 class="box-title">Order Report 
                  <small>Filter</small>
                </h3>
                <!-- tools box -->
...
-->
            ...
            <div class="box box-primary" style="padding-left:10px; padding-right:10px;">
              ...
              <div class="box-body table-responsive no-padding" id="printBody">
                <div class="col-md-6"><h4><strong>Sales App Order Report</strong></h4></div><div class="col-md-6" align="right"><h4><strong>{{reportDateInfo}}</strong></h4></div>
                <table class="table table-hover" id="tableToExport">
                  <thead>
                    <tr>
                      ...
                      <th ng-click="sort('orderDate')">Date
                      ...
                      <th ng-click="sort('item')">Order Item
                        <span class="glyphicon sort-icon" ng-show="sortKey=='ordDescription'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                      </th>
                      <th ng-click="sort('price')">Order Price
                      ...
                      <th ng-click="sort('totalPrice')">Total
                  ...
                  <tbody>
                    <tr dir-paginate="order in orders|orderBy:sortKey:reverse|filter:search|itemsPerPage:10000000">
                      <td>{{$index + 1}}</td>
                    ...
                    <tr>
                      ...
                      <td><h4><strong>&#8377; {{orderTotalAmount}}</strong></h4></td>
                    </tr>
                  </tbody>
                  </table>
