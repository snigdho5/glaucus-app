...
<div class="wrapper" ng-controller="rochakcreditreport">
          ...
          <div class="col-md-12">
            ...
            <div class="box box-primary">
              <div class="box-header">
                <h3 class="box-title">Credit Report 
                  <small>Filter</small>
                </h3>
                <!-- tools box -->
            ...
            <div class="box box-primary" style="padding-left:10px; padding-right:10px;">
              ...
              <div class="box-body table-responsive no-padding" id="printBody">
                  <div class="col-md-6"><h4><strong>Sales App Credit Report</strong></h4></div><div class="col-md-6" align="right"><h4><strong>{{reportDateInfo}}</strong></h4></div>
                <table class="table table-hover" id="tableToExport">
                  <thead>
                    <tr>
                      ...
                      <th ng-click="sort('creditDate')">Credit Date
                      ...
                      <th ng-click="sort('credit')">Credit Amount
                      ...
                      <th ng-click="sort('settled')">Credit Settled
                        <span class="glyphicon sort-icon" ng-show="sortKey=='ordStatus'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                      </th>
                      <th ng-click="sort('outstanding')">Credit Outstanding
                        <span class="glyphicon sort-icon" ng-show="sortKey=='ordStatus'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                      </th>  
                    </tr>
                  </thead>
                  <tbody>
                    <tr dir-paginate="credit in credits|orderBy:sortKey:reverse|filter:search|itemsPerPage:10000000">
                      <td>{{$index + 1}}</td>
                    ...
                    <tr>
                      ...
                      <td><h4><strong>&#8377; {{creditTotalAmount}}</strong></h4></td>
                    </tr>
                  </tbody>
                  </table>
