<div class="wrapper" ng-controller="customerinfoCtrl">
    ...
    <div class="container">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">All Customer Info</li>
        </ol>
      </section>
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th ng-click="sort('cusShopName')">Company Name
                      <span class="glyphicon sort-icon" ng-show="sortKey=='cusShopName'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                    </th>
                ...
                <tbody>
                  <tr dir-paginate-start="customer in customers|orderBy:sortKey:reverse|filter:search|itemsPerPage:5" ng-click="expanded = !expanded">
                    ...
                    <td>
                      <a class="btn btn-social-icon btn-danger" ng-click="goToDetail(customer)" title="Detail"><i class="fa fa-eye"></i></a>
                    </td>
                  </tr>
