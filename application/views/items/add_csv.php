    ...
    <div class="container">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Import Item CSV</li>
        </ol>
      </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Import Item CSV</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
<!--                    <form name="addForm" novalidate>-->
                    ...
                    <?php } ?>
                    <form method="post" action="<?= base_url() ?>itemmanagement/add_csv" enctype="multipart/form-data">
                        <div class="box-body">
                            
                            <div class="row col-md-12">
                                
                                <div class="form-group col-md-6 col-md-offset-3">
                                    <label for="userPackageName">Upload Item CSV File : *</label>
                        ...
                        <div class="box-footer">
                            ...
                            <button type="submit" class="btn btn-danger pull-right">Upload Item CSV</button>
                        </div>
                    </form>
                </div>
                <!-- /.box -->
