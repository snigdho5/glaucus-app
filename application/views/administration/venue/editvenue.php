<div class="wrapper" ng-controller="editVenueCtrl">
        ...
        <div class="box box-primary">
          ...
          <form name="addForm" novalidate>
            ...
            <div class="box-footer">
              <button type="submit" class="btn btn-default pull-left" ng-click="cancelEditVenue()">Cancel</button>
              <button type="submit" class="btn btn-primary pull-right" ng-disabled="addForm.$invalid" ng-click="submitUpdateVenue()">Update</button>
            </div>
          </form>
        </div>
        <!-- /.box -->
