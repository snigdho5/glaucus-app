<div class="wrapper" ng-controller="addAdminCtrl">
          ...
          <form name="addForm" novalidate>
            ...
            <div class="row col-md-12">
                ...
                <div class="form-group col-md-12">
                  <label for="venUnitId">Select Single/Multiple Unit*</label>
                  <div
                      isteven-multi-select
                      input-model="inputUnits"
                      output-model="outputUnits"
            ...
            <button type="submit" class="btn btn-default pull-left" ng-click="cancelAddAdmin()">Cancel</button>
              <button type="submit" class="btn btn-primary pull-right" ng-disabled="addForm.$invalid" ng-click="submitAddAdmin()">Submit</button>
            </div>
          </form>
        </div>
        <!-- /.box -->
