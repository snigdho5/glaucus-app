                        ...
                        <table class="table table-hover">
                          <thead>
                            <tr>
                              ...
                              <th ng-click="sort('plreqDateFrom')">Leave From
                                <span class="glyphicon sort-icon" ng-show="sortKey=='plreqDateFrom'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                              </th>
                              <th ng-click="sort('plreqDateTo')">Leave To
                                <span class="glyphicon sort-icon" ng-show="sortKey=='plreqDateTo'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                              </th>
                          ...
                          <tbody>
                            <tr dir-paginate="plrequest in plrequests|orderBy:sortKey:reverse|filter:search|itemsPerPage:5">
                              ...
                              <td>{{plrequest.plreqDateFrom}}</td>
                              <td>{{plrequest.plreqDateTo}}</td>
                        ...
                        <table class="table table-hover">
                          <thead>
                            <tr>
                              ...
                              <th ng-click="sort('plreqDateFrom')">Leave From
                                <span class="glyphicon sort-icon" ng-show="sortKey=='alreqDateFrom'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                              </th>
                              <th ng-click="sort('plreqDateTo')">Leave To
                                <span class="glyphicon sort-icon" ng-show="sortKey=='alreqDateTo'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                              </th>
                          ...
                          <tbody>
                            <tr dir-paginate="alrequest in alrequests|orderBy:sortKey:reverse|filter:search|itemsPerPage:5">
                              ...
                              <td>{{alrequest.alreqDateFrom}}</td>
                              <td>{{alrequest.alreqDateTo}}</td>
                        ...
                        <table class="table table-hover">
                          <thead>
                            <tr>
                              ...
                              <th ng-click="sort('plreqDateFrom')">Leave From
                                <span class="glyphicon sort-icon" ng-show="sortKey=='rlreqDateFrom'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                              </th>
                              <th ng-click="sort('plreqDateTo')">Leave To
                                <span class="glyphicon sort-icon" ng-show="sortKey=='rlreqDateTo'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                              </th>
                          ...
                          <tbody>
                            <tr dir-paginate="rlrequest in rlrequests|orderBy:sortKey:reverse|filter:search|itemsPerPage:5">
                              ...
                              <td>{{rlrequest.rlreqDateFrom}}</td>
                              <td>{{rlrequest.rlreqDateTo}}</td>
